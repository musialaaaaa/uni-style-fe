      ...
      render: (_, record) => (
        <Space size="small">
          ...
          <Popconfirm
            ...
            cancelText="Không"
          >
            <Button type="text" icon={<DeleteOutlined />} size="small" title="Xóa" danger />
          </Popconfirm>
        </Space>
      ),
    },
    ...
    <div style={{ padding: 24 }}>
      ...
      >
        ...
        >
          ...
          >
            <TextArea rows={3} placeholder="Nhập địa chỉ giao hàng đầy đủ" />
          </Form.Item>
          ...
          <Row gutter={16}>
            ...
            <Col span={8}>
              <Form.Item label="Mã voucher" name="coupon_id">
                <Input prefix={<CreditCardOutlined />} placeholder="KM20 (không bắt buộc)" />
              </Form.Item>
            </Col>
          </Row>
