...
const mockCategories = [
    ...
    {
        id: 2,
        created_at: '2024-12-02 14:15:30',
        created_by: 'manager',
        updated_at: '2024-12-15 09:20:00',
        updated_by: 'admin',
        is_deleted: false,
        name: 'Quần jeans'
    },
    {
        id: 3,
        created_at: '2024-12-03 09:45:00',
        created_by: 'staff_01',
        updated_at: '2024-12-10 16:30:00',
        updated_by: 'manager',
        is_deleted: true,
        name: 'Áo khoác'
    },
    {
        id: 4,
        created_at: '2024-12-05 16:20:00',
        created_by: 'admin',
        updated_at: '2024-12-05 16:20:00',
        updated_by: 'admin',
        is_deleted: false,
        name: 'Váy đầm'
    },
    {
        id: 5,
        created_at: '2024-12-08 11:10:00',
        created_by: 'manager',
        updated_at: '2024-12-18 14:45:00',
        updated_by: 'staff_01',
        is_deleted: false,
        name: 'Phụ kiện'
    },
    {
        id: 6,
        created_at: '2024-12-10 13:25:00',
        created_by: 'staff_02',
        updated_at: '2024-12-12 10:15:00',
        updated_by: 'admin',
        is_deleted: true,
        name: 'Giày dép'
    },
    {
        id: 7,
        created_at: '2024-12-12 08:40:00',
        created_by: 'admin',
        updated_at: '2024-12-19 11:30:00',
        updated_by: 'manager',
        is_deleted: false,
        name: 'Túi xách'
    },
    {
        id: 8,
        created_at: '2024-12-15 15:55:00',
        created_by: 'manager',
        updated_at: '2024-12-15 15:55:00',
        updated_by: 'manager',
        is_deleted: false,
        name: 'Đồ thể thao'
    }
...
const CategoryManagement = () => {
    ...
    const handleToggleDelete = (record) => {
        const action = record.is_deleted ? 'khôi phục' : 'xóa';
        ...
        message.success(`${action === 'xóa' ? 'Xóa' : 'Khôi phục'} danh mục thành công!`);
    };
            ...
            <Card>
                        ...
                        <Col>
                            <Space>
                                <Button
                                    ...
                                    type={showDeletedCategories ? 'primary' : 'default'}
                                    style={{
                                        borderRadius: 8
                                    }}
                                >
                                    {showDeletedCategories ? '👁️ Hiện danh mục hoạt động' : '🗑️ Hiện danh mục đã xóa'}
                                </Button>
                                <Button
                                    type="primary"
                                    icon={<PlusOutlined />}
                ...
                <div style={{ marginBottom: 16 }}>
                    <Row gutter={16} align="middle">
                        ...
                        <Col>
                            <Text type="secondary">
                                Hiển thị {showDeletedCategories ? 'đã xóa' : 'hoạt động'}: {filteredCategories.length} danh mục
                            </Text>
                        </Col>
                    </Row>
                </div>
                        ...
                        <Row gutter={[16, 16]}>
                                ...
                                <Card size="small" title="Thông tin tạo" style={{ borderRadius: 8 }}>
                                    <Space direction="vertical" style={{ width: '100%' }}>
                                        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                                            {getCreatorAvatar(viewingCategory.created_by)}
                                            <div>
                                                <Text strong>{viewingCategory.created_by}</Text>
                                        ...
                                        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                                            ...
                                            <div>
                                                <Text>{dayjs(viewingCategory.created_at).format('DD/MM/YYYY HH:mm:ss')}</Text>
                            ...
                            <Col span={12}>
                                <Card size="small" title="Cập nhật cuối" style={{ borderRadius: 8 }}>
                                    <Space direction="vertical" style={{ width: '100%' }}>
                                        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                                            {getCreatorAvatar(viewingCategory.updated_by)}
                                            <div>
                                                <Text strong>{viewingCategory.updated_by}</Text>
                                        ...
                                        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                                            ...
                                            <div>
                                                <Text>{dayjs(viewingCategory.updated_at).format('DD/MM/YYYY HH:mm:ss')}</Text>
