...
const AdminLayout = ({
    ...
    const getSelectedKeys = () => {
        console.log('getSelectedKeys called with currentPage:', currentPage);
        switch (currentPage) {
            case 'products':
                return ['product-list'];
            case 'add-product':
    ...
    return (
        <Layout className={`admin-layout ${isDarkMode ? 'dark-theme' : 'light-theme'}`} style={{ minHeight: '100vh' }}>
            {/* Sidebar */}
            <Sider
                trigger={null}
                collapsible
            ...
            >
                ...
                <Menu
                    ...
                    onClick={({ key, domEvent }) => {
                        ...
                        console.log('Current page prop:', currentPage);
                        console.log('Event object:', domEvent);

                        if (onMenuClick) {
                            console.log('Calling onMenuClick with key:', key);
                            onMenuClick(key);
                        } else {
                            console.log('ERROR: onMenuClick is not available');
                        }
                    }}
                    style={{
